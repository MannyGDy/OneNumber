...
const VanityNumberGetStarted = () => {
  return (
    <section className="container mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="w-full rounded-lg p-6 md:p-8 mb-8">
        ...
        <div className="flex flex-wrap gap-[1.2rem] justify-center items-center">
          {/* Step 1 */}
          <div className="flex md:w-[47%]  flex-col items-center">
            <div className="mb-4">
              <svg
          ...
          <div className="flex md:w-[47%]  flex-col items-center">
            ...
            <h3 className=" md:!text-lg text-center !text-[1.25rem] text-dark mb-2">
              Download the App
            </h3>
            <p className="text-sm text-center text-gray-600">
...
export default VanityNumberGetStarted;
